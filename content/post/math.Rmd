...
```{r}
## Find the derivative of the function f(x)= 2x^3+3x^2 +2x +9-5sin^(x) +ln(x)      ## "calculus" package
library(calculus)
derivative(f = "2*x^3 + 3*x^2 +2*x +9-5*sin(x)^2", var = "x")

```

derivative(f = "2x^3+3x^2 +2x +9-5sin^(x)+ln(x)", var = "x")
